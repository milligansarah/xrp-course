...
const data: CourseData = {
  ...
  'Lesson 3 - Methods, Classes, and Objects': {
    ...
    'Classes & Objects': {
      ...
      6: {
        actionType: ActionType.Search,
        content: <p>You already saw how on lines 20 and 21, two XRPMotor objects are created. On line 29, these objects are used to create a “DifferentialDrive” object. DifferentialDrive is another class that has been created for us that has some built-in functionality that handles the math that converts joystick values to motor outputs. For this class to work it needs motors to output to, which is why you can see at the end of line 29 that the two XRPMotor objects are being used to create the DifferentialDrive object, called m_diffDrive. Scroll down and on line 46 you’ll see m_diffDrive.arcadeDrive(xaxisSpeed, zaxisRotate), which you’re familiar with from lesson 2. This is an example of using an object to do something – in this case, the m_diffDrive object, and we’re using the “arcadeDrive” method that has been declared as part of the DifferentialDrive class. This is another critical concept when it comes to classes and objects – methods can be defined as part of the behavior for the class. Then those methods can be called using objects of that class.</p>
      },
      7: {
        actionType: ActionType.Read,
